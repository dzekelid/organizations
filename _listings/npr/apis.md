...
- name: NPR Get a variety of details about an organization including various lists
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/organizations/master/_listings/npr/listening-v2-organizations-orgid-recommendations-get-postman.md
x-common:
- type: x-base

...
- name: Global Change Information System API List organizations.
  ...
  baseURL: https://data.globalchange.gov////organization
  tags: Organizations
  properties:
...
- name: Global Change Information System API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/organizations/master/_listings/globalchange-gov/openapi.md
x-common:
- type: x-developer
